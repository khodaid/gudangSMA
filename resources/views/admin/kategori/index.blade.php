...
@section('content')
                ...
                <form action="{{ route('kategori.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="inputNama">Nama Kategori Barang</label>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h3 class="my-1 font-weight-bold text-primary">Kategori Barang</h3>
            <div class="row">
                    ...
                    <tbody>
                        @foreach ($kategoris as $kategori)
                            <tr>
                                ...
                                <td>{{ $kategori->nama }}</td>
                                <td>{{ Str::limit($kategori->deskripsi, 20) }}</td>
                                <td>
    ...
    <div class="modal fade " id="mediumModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Data Kategori Barang</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
