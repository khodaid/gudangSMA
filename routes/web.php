...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('private')->group(function () {
        ...
        Route::middleware('admin')->group(function () {
            ...
            Route::get('pengduan/{pengaduan}/edit',[PengaduanController::class,'edit'])->name('pengaduan.edit');
            Route::put('pengaduan/{pengaduan}/update',[PengaduanController::class,'update'])->name('pengaduan.update');
            Route::get('pengaduan/{pengaduan}/destroy',[PengaduanController::class,'destroy'])->name('pengaduan.destroy');
